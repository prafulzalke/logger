...
$result = $database->getLatestDataLog($node);
$dashboardCnt = $database->getCountForDashboard();
//echo '<pre>';print_r($result);die;
//$log = new ErrorLog();
//$log->process(null, null, null, null, $result[date('Y-m-d')]);

//print_r($dashboardCnt);
//die;
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content-header">
      <h1>
          BASpubweb1/BASpubweb2
        <small>Apache log date :</small>
          <?php echo date('d-M-Y')?>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                  <div class="inner">
                      <h3><?php echo number_format($result[date('Y-m-d')]['NOTICE'], 0);?></h3>
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                  <div class="inner">
                      <h3><?php echo number_format($result[date('Y-m-d')]['WARNING'], 0);?></h3>
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                  <div class="inner">
                      <h3><?php echo number_format($result[date('Y-m-d')]['ERROR'], 0);?></h3>
      ...
      <div class="box box-info">
          <div class="box-header with-border">
              <h3 class="box-title">Last 2 week</h3>
          ...
          <div class="box-body">
              <div class="table-responsive">
                  <table class="table no-margin">
                      ...
                      <tbody>
                      <?php foreach($result as $date => $row) :?>
                      <tr>
                          <td><a href=""><?php echo date('d-M-Y', strtotime($date));?></a></td>
                          <td><a href="/logger/details.php?type=NOTICE&node=<?php echo $node;?>&log_date=<?php echo $date;?>"><span class="label label-info" style="font-size: 13px; width: 55px; display: block"><?php echo number_format($row['NOTICE'], 0);?></span></a></td>
                          <td><a href="/logger/details.php?type=WARNING&node=<?php echo $node;?>&log_date=<?php echo $date;?>"><span class="label label-warning" style="font-size: 13px !important; width: 55px; display: block"><?php echo number_format($row['WARNING'],0);?></span></td>
                          <td><a href="/logger/details.php?type=ERROR&node=<?php echo $node;?>&log_date=<?php echo $date;?>"><span class="label label-danger" style="font-size: 13px; width: 55px; display: block"><?php echo number_format($row['ERROR'],0);?></span></td>
                      </tr>
                      <?php endforeach;?>
                      </tbody>
                  </table>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Monthly Bug Report</h3>
              ...
              <div class="box-tools pull-right">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">Action</a></li>
                    <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">Another action</a></li>
                    <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">Something else here</a></li>
                    <li class="divider"></li>
                    <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">Separated link</a></li>
                  </ul>
                </div>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
          ...
          <div class="box box-default">
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="chart-responsive">
                    <canvas id="pieChart" height="155" width="275" style="width: 275px; height: 155px;"></canvas>
                  </div>
                  <!-- ./chart-responsive -->
                </div>
                <!-- /.col -->
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">United States of America
                  <span class="pull-right text-red"><i class="fa fa-angle-down"></i> 12%</span></a></li>
                <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">India <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a>
                </li>
                <li><a href="http://extranet.bas-dev.net/themes/AdminLTE/index2.html#">China
